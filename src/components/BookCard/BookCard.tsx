...
export function BookCard({imageUrl,title,authors,pageCount,publisher,published,
                            category,description,id,isbn10,isbn13,language}:Book){
                ...
                <div className="info">
                    <div className="header">
                        ...
                        {authors.map((authorName:string)=>{
                            return <span key={authorName} className='author'>{authorName}</span>
                        })}
                    </div>
