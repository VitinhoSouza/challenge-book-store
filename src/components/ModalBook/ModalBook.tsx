...
export function ModalBook({imageUrl,title,authors,pageCount,publisher,published,
                            category,description,id,isbn10,isbn13,language,toggleModal}:ModalBookProps){
